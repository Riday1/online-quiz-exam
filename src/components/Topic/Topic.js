...
import { BeakerIcon, ArrowSmallRightIcon } from '@heroicons/react/24/solid';
import { Link } from 'react-router-dom';

const Topic = ({ topic }) => {
    const { name, logo, total, id } = topic;
    return (
        <div className='shadow-md w-[280px] rounded-lg'>
            <img className='w-[250px] rounded-md m-[15px] bg-green-200' src={logo} alt="" />
